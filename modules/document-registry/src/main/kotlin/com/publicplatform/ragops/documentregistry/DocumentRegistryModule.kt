 ...
 * Python ingestion-worker가 청킹·임베딩 완료 후 DocumentWriter를 통해 청크를 저장한다.
 *
 * ## 주요 포트 계약
 * - [DocumentReader]: 문서 목록 조회 (기관 스코프 필터)
 * - [DocumentVersionReader]: 문서 버전 이력 조회
 * - [DocumentWriter]: 문서 저장, 수집/인덱스 상태 갱신, 청크 저장
 *
 * ## 주요 DB 테이블
