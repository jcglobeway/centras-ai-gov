...
class RagasEvaluationEntity(
    ...
    fun toSummary() = RagasEvaluationSummary(
        id = id, questionId = questionId, faithfulness = faithfulness,
        answerRelevancy = answerRelevancy, contextPrecision = contextPrecision,
        contextRecall = contextRecall, evaluatedAt = evaluatedAt,
        judgeProvider = judgeProvider, judgeModel = judgeModel,
    )
}
