...
17. [17_development_wbs_milestones.md](/C:/Users/User/Documents/work/mvp_docs/17_development_wbs_milestones.md)
전체 개발 WBS, 마일스톤, 선행 관계, Mermaid 일정 시각화

18. [99_worklog.md](/C:/Users/User/Documents/work/mvp_docs/99_worklog.md)
진행 기록과 다음 액션
...
- 다음 구현 시작점은 `17_development_wbs_milestones.md`의 `M1 Action auth policy`, `M2 Worker callback contract` 순서다.
